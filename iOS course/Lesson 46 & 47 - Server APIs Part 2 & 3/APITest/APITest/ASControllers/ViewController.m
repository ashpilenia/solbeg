...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *loadGroupWallButton = [[UIBarButtonItem alloc]
                                            initWithBarButtonSystemItem:UIBarButtonSystemItemAction
                                                                                         target:self
                                                                                        action:@selector(showWall:)];
    
    self.navigationItem.rightBarButtonItem = loadGroupWallButton;
}
...
- (void)showWall:(UIBarButtonItem *)sender {
    
    ASGroupWallController *vc = [[ASGroupWallController alloc] init];
